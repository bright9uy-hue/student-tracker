...
window.SmartAlertsPanel = {
    ...
    template: `
        <div v-if="activeClass" class="content-card" style="margin-bottom: 1.5rem;">
            <div style="display:flex; align-items:center; gap:0.5rem;">
                ...
                <span v-if="!uiState.hideSmartAlerts && alerts.length" style="background:rgba(239,68,68,0.15); color:#ef4444; font-size:0.75rem; font-weight:800; padding:0.15rem 0.55rem; border-radius:10px;">{{ alerts.length }}</span>
                <button class="btn btn-secondary btn-sm" style="margin-right:auto; padding:0.3rem 0.6rem;"
            ...
            <template v-if="!uiState.hideSmartAlerts">
    ...
    setup(props) {
        ...
        return { uiState, alerts, severityColor, severityBg, toggleSmartAlertsVisibility };
    }
};
